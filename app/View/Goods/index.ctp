<div class="goods index">
	...
	<tr>
		...
		<td><?php echo h($good['Good']['description']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $good['Good']['id']), null, __('Are you sure you want to delete # %s?', $good['Good']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
